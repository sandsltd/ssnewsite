        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/blogs/seo-tips-dorset-businesses" className="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              ...
              <Link href="/blogs/web-design-yeovil-case-study" className="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          <section className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Link href="/blogs/website-redesign-roi" className="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              ...
              <Link href="/blogs/mobile-first-design-2025" className="block p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          <div className="mt-8 text-center">
            <Link href="/blogs" className="text-blue-600 hover:text-blue-800 font-semibold">
              ← Back to Blog
            </Link>
          </div>
        </div>
