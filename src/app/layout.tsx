...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon-16x16.png?v=ss-logo-1', sizes: '16x16', type: 'image/png' },
      { url: '/favicon-32x32.png?v=ss-logo-1', sizes: '32x32', type: 'image/png' },
      { url: '/favicon.ico?v=ss-logo-1', sizes: '16x16 32x32 48x48', type: 'image/x-icon' },
    ],
    apple: [
