    ...
    <div className="bg-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "name": "Web Design Somerset",
            "description": "Expert web design services across Somerset. Local website designers creating stunning, mobile-responsive websites for Somerset businesses.",
            "provider": {
              "@type": "LocalBusiness",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              What We Do for <span className="text-blue-600">Somerset Businesses</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive web design services tailored to help businesses across Somerset succeed online.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Custom-built websites designed specifically for Somerset businesses, optimised for performance and local SEO.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Keep your Somerset business website running smoothly with our comprehensive support packages.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 mb-4">
                Help your Somerset business get found online with targeted local SEO and digital marketing.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Serving <span className="text-blue-600">Somerset Communities</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We're proud to serve businesses across Somerset with professional web design services
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Yeovil</h3>
              <p className="text-sm text-gray-600">Web Design Yeovil</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Taunton</h3>
              <p className="text-sm text-gray-600">Web Design Taunton</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Bridgwater</h3>
              <p className="text-sm text-gray-600">Web Design Bridgwater</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Bath</h3>
              <p className="text-sm text-gray-600">Web Design Bath</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Wells</h3>
              <p className="text-sm text-gray-600">Web Design Wells</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Glastonbury</h3>
              <p className="text-sm text-gray-600">Web Design Glastonbury</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Frome</h3>
              <p className="text-sm text-gray-600">Web Design Frome</p>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <h3 className="font-semibold text-gray-900">Street</h3>
              <p className="text-sm text-gray-600">Web Design Street</p>
            </div>
          </div>

          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">
              Don't see your area? We serve businesses throughout Somerset and surrounding counties.
            </p>
      ...
      {/* About Us Section */}
      <AboutUsSection 
        title="Meet Your Somerset Web Design Team"
        subtitle="Nick & Dan from Saunders Simmons Ltd - your dedicated local web design partners serving businesses across Somerset."
        showVideo={true}
      ...
      <CustomerSuccessSection 
        title="Somerset Client Success Stories"
        subtitle="Genuine testimonials from satisfied Somerset clients who chose Saunders Simmons for their web design needs."
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Common questions about our web design services across Somerset
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                Do you work with businesses throughout Somerset?
              </h3>
              <p className="text-gray-700">
                Yes! We serve businesses across all of Somerset, from Yeovil to Taunton, Bridgwater to Bath. 
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                Can you help with local SEO for Somerset businesses?
              </h3>
              <p className="text-gray-700">
                Absolutely! We specialise in local SEO for Somerset businesses. Every website includes basic SEO setup, 
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                We're based in Somerset, understand the local business landscape, and focus on building long-term partnerships. 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to Transform Your Somerset Business Online?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Join the 100+ local businesses across Somerset who trust Saunders Simmons for their web design needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
