      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <span className="text-lg text-gray-600">• 9 Google Reviews</span>
          </div>
          
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            See What Our <span className="text-blue-600">Real Clients</span> Say
          </h2>
          ...
          <Link 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition-colors duration-200 shadow-lg hover:shadow-xl"
          >
