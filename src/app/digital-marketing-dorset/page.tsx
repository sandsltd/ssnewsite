    ...
    <div className="bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              ...
              mobile-responsive websites that help local businesses from Poole to Dorchester succeed online.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Professional Web Design Services Across Dorset
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From Bournemouth to Weymouth, we create custom websites that help Dorset businesses thrive online.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Bespoke website design tailored to your Dorset business needs and local market.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Local Dorset SEO</h3>
              <p className="text-gray-600">
                Optimised for local searches across Dorset towns and villages to help customers find you.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">
                Perfect on all devices - ensuring your Dorset customers have a great experience.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We provide professional web design services to businesses throughout Dorset
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              'Christchurch', 'Ferndown', 'Wimborne', 'Blandford Forum',
              'Shaftesbury', 'Gillingham', 'Sherborne', 'Swanage',
              'Wareham', 'Lyme Regis', 'Bridport', 'Verwood'
            ].map((town) => (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Meet Your Local <span className="text-blue-600">Dorset Web Design Team</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Nick & Dan from Saunders Simmons Ltd - experienced web design professionals serving Dorset businesses.
            </p>
          </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="aspect-video bg-gray-900 relative overflow-hidden rounded-2xl shadow-xl">
                <iframe
                  ...
                  title="Meet Nick & Dan - Your Dorset Web Design Team"
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Nick and Dan bring years of experience in web development and digital marketing. 
                    Their passion for helping businesses thrive online has made Saunders Simmons Ltd 
                    a trusted partner for companies across Dorset and the South West.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                    ...
                    <p className="text-gray-600 text-sm">
                      Lead Developer & Co-Founder. Specialises in creating fast, modern websites that help Dorset businesses convert visitors into customers.
                    </p>
                  </div>
                  <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                    <h4 className="font-semibold text-gray-900 mb-2">Dan Simmons</h4>
                    <p className="text-gray-600 text-sm">
                      Marketing Director & Co-Founder. Expert in local SEO and helping Dorset businesses grow their online presence.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 p-6 rounded-xl">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    We focus on building long-term business relationships through comprehensive web development 
                    and ongoing support packages designed to help your Dorset business grow and succeed online.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4 pt-4 mb-6">
                  ...
                  <div className="text-gray-500">•</div>
                  <div className="text-gray-600">Established 2020</div>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Affordable Web Design Packages for Dorset Businesses
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-blue-100">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-4">Perfect for Dorset businesses getting online</p>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span>SEO optimisation for Dorset searches</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-purple-100 relative">
              ...
              <div className="text-center mb-6 mt-4">
                ...
                <p className="text-gray-600 mb-4">Keep your Dorset business online</p>
                <div className="flex items-baseline justify-center mb-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-green-300 relative">
              ...
              <div className="text-center mb-6 mt-4">
                ...
                <p className="text-gray-600 mb-4">Complete marketing for Dorset businesses</p>
                <div className="flex items-baseline justify-center mb-6">
                  <span className="text-sm text-gray-500 mr-2">Monthly</span>
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center">
                  ...
                  <span>Local SEO for Dorset searches</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Case Study 1 - Using remaining reviews not used on other pages */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                <div className="text-white text-center">
                  <h3 className="text-xl font-bold mb-2">Service Business</h3>
                  <p className="text-blue-100">Professional Results</p>
                </div>
              </div>
              <div className="p-6">
                <h4 className="font-bold text-gray-900 mb-2">"Exceeded all expectations"</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Professional website development with excellent results that helped expand our business reach and customer engagement.
                </p>
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  Verified Client - Service Provider
                </div>
              </div>
            </div>

            {/* Case Study 2 - Real testimonial approach */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center">
                <div className="text-white text-center">
                  <h3 className="text-xl font-bold mb-2">Professional Service</h3>
                  <p className="text-green-100">Outstanding Communication</p>
                </div>
              </div>
              <div className="p-6">
                <h4 className="font-bold text-gray-900 mb-2">"Professional & Reliable"</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Excellent communication throughout the project with professional results delivered on time and within budget.
                </p>
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  Verified Client - Business Owner
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center">
                <div className="text-white text-center">
                  ...
                  <p className="text-purple-100">Great Value</p>
                </div>
              </div>
              <div className="p-6">
                <h4 className="font-bold text-gray-900 mb-2">"Highly Recommended"</h4>
                <p className="text-gray-600 text-sm mb-4">
                  Great value for money with professional service that delivered exactly what was promised. Would recommend to other businesses.
                </p>
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  Verified Client - Local Business
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Dorset Businesses <span className="text-blue-600">Trust Us</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Established web design team with proven results and professional service.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Experienced team delivering quality results</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Years of experience serving South West businesses</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Successful websites delivered across the region</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Web Design Dorset - Frequently Asked Questions
            </h2>
            <p className="text-lg text-gray-600">
              Common questions from Dorset businesses about our web design services
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Do you provide web design services across all of Dorset?
              </h3>
              <p className="text-gray-600">
                Yes! We provide professional web design services to businesses throughout Dorset, 
                including Bournemouth, Poole, Dorchester, Weymouth, and all surrounding areas.
              </p>
            </div>

            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                How much does web design cost for Dorset businesses?
              </h3>
              <p className="text-gray-600">
                Our professional website design starts from just £249 + VAT for a 5-page website. 
                This includes mobile-responsive design, SEO optimisation, and everything your Dorset 
            ...
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                How long does it take to build a website for my Dorset business?
              </h3>
              <p className="text-gray-600">
                Most websites are completed within 2-3 weeks. We'll work with your Dorset business 
            ...
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Do you understand the Dorset market?
              </h3>
              <p className="text-gray-600">
                Absolutely! We work with businesses across Dorset and understand the local market dynamics, 
                customer behaviour, and what web design approaches work best for Dorset businesses.
              </p>
            </div>

            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Do you provide ongoing support for Dorset businesses?
              </h3>
              <p className="text-gray-600">
                Yes! We offer Basic Hosting from £25/month or our Continuous Growth package at £250/month, 
                which includes hosting, SEO, unlimited updates, and priority support for Dorset businesses.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to Get Your Dorset Business Online?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Join successful Dorset businesses with professional websites. 
            From Bournemouth to Weymouth, we help local businesses grow online.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Call Now: 03300 436608
            </Link>
          </div>

          <div className="mt-8 text-blue-100">
            <p className="text-sm">
              Serving All of Dorset • 5.0 Google Rating • No Long-term Contracts
            </p>
          </div>
        </div>
      </section>
