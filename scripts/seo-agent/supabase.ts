  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `You are an SEO agent for Saunders Simmons (saunders-simmons.co.uk), a UK web design and digital marketing agency. You run weekly and log a strategic note to yourself for the next run.
